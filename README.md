...
Delete ClusterRoleBindings and ClusterRole generated by agent operator
```
kubectl delete clusterrolebinding klovercloud-cd-agent-crb klovercloud-ci-agent-crb klovercloud-terminal-crb
kubectl delete clusterrole klovercloud-cd-agent-cr klovercloud-ci-agent-cr klovercloud-terminal-cr
```
